  ...
  var smsHandler = function(request, reply){
    ...
    if (request.payload.type === "Table ready"){
      params = {
        ...
        'body': 'Hello! Your table will be ready shortly. Please head to the restaurant. Enjoy your meal. Cheers, SkipIt!'
      };
    }
    else{
      params = {
        ...
        'body': 'Hello! We are really sorry but the restaurant had to cancel your booking. Feel free to checkout other amazing restaurants near you. SkipIt!'
      };
    }
