  ...
  var smsHandler = function(request, reply){
    ...
    if (request.payload.type === "Table ready"){
      params = {
        ...
        'body': 'Hello! Your table will be ready shortly. Please head to the restaurant. Cheers, Haozhan! Next time skip the queue and book your spot on the waiting list with Skipit: www.skipitapp.co/#tryit'
      };
    }
    else{
      params = {
