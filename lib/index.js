...
var SmsCancel = require('./smsCancel.js');
...
//REMEMBER TO ADD  HERE
  server.register([Inert, Sms, SmsCancel, RestaurantSpecific, CheckIn, userSignup, userLogin, favicon], function(err){
    if (err) {
      return next(err);
    }
  });
